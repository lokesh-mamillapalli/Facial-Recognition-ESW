                ...
                objectDetectorListener =
                    object : ObjectDetectorHelper.DetectorListener {
                        ...
                        override fun onPersonCount(count: Int) {
                            ...
                            // You might want to add an assertion or just leave it empty if not used in this test
                        }
                        override fun detectEmotion(bitmap: Bitmap): String {
                            // Implement emotion detection or return a default value
                            return "neutral"
                        }
                    }
            )
